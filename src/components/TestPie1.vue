...
//This component listens for "pie-spin" events and animates pie slices accordingly.
...
//explain this function :converts polar coordinates to cartesian coordinates
...
// Function that triggers only once when value goes above 0, and resets when it goes back to 0
